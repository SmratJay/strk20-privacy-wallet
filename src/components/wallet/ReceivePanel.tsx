...
/**
 * The privacy receive surface. For the STRK20 Wallet API lane, the receive identifier IS the
 * connected wallet's Starknet address — the privacy wallet owns viewing keys, channels, and note
 * discovery. The address is only a *working* private receive address once private receiving is
 * READY (i.e. the viewing key is registered and the wallet has granted private-balance access).
 *
 * Honesty rule: the "Anyone can send you a private payment" claim and the private-share text are
 * only shown when READY. Otherwise we show the address as the identity but state clearly that
